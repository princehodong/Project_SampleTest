...
namespace VoxelImporter
{
    public abstract class VoxelBaseEditor : Editor
    {
        ...
        protected bool afterRefresh = false;
        ...
        protected virtual void OnSceneGUI()
        {
            ...
            SetSelectedWireframeHidden(baseTarget.edit_configureMode != VoxelBase.Edit_configureMode.None);
        ...
        public virtual void SetSelectedWireframeHidden(bool hidden)
        {
            if (baseTarget != null)
            {
                var renderer = baseTarget.GetComponent<Renderer>();
                if (renderer != null)
